var r=Object.defineProperty,s=(d,t,e)=>t in d?r(d,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):d[t]=e,a=(d,t,e)=>(s(d,typeof t!="symbol"?t+"":t,e),e);class i{constructor(){a(this,"currentDate"),this.currentDate=new Date().toLocaleDateString("fr-FR",{year:"numeric",month:"long",day:"numeric"})}generateReport(){return`<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
...
</html>`}generateDashboardSection(){return`
    <!-- 1. DASHBOARD -->
    ...
    <div class="page-break"></div>
    `}generateCityCards(){return[{name:"Paris",score:8.08,ebitda:.12,equity:.95,status:"RECOMMANDÉ",color:"#dcfce7"},{name:"Singapour",score:8.06,ebitda:.01,equity:.81,status:"POSSIBLE",color:"#fef3c7"},{name:"Genève",score:7.86,ebitda:-.09,equity:.89,status:"RECOMMANDÉ",color:"#dcfce7"},{name:"Amsterdam",score:7.67,ebitda:.04,equity:.87,status:"POSSIBLE",color:"#fef3c7"},{name:"Chypre",score:7.41,ebitda:.2,equity:3.13,status:"POSSIBLE",color:"#fef3c7"},{name:"Hambourg",score:7.32,ebitda:.05,equity:.93,status:"POSSIBLE",color:"#fef3c7"},{name:"Londres",score:7.06,ebitda:-.34,equity:1,status:"POSSIBLE",color:"#fef3c7"},{name:"Dubai",score:6.5,ebitda:0,equity:2.59,status:"POSSIBLE",color:"#fef3c7"},{name:"Maurice",score:6.26,ebitda:.41,equity:3.76,status:"NON RECOMMANDÉ",color:"#fee2e2"},{name:"Tel Aviv",score:6.18,ebitda:-.03,equity:2.17,status:"NON RECOMMANDÉ",color:"#fee2e2"},{name:"Maroc CFC",score:6.01,ebitda:.47,equity:5.67,status:"NON RECOMMANDÉ",color:"#fee2e2"},{name:"Andorre",score:5.23,ebitda:.38,equity:2.88,status:"NON RECOMMANDÉ",color:"#fee2e2"}].map((t,e)=>`
        <div class="city-card" style="background-color: ${t.color};">
            <h4>${e+1}. ${t.name}</h4>
            <div class="city-metric">
                <span class="city-metric-label">Score Global:</span>
                <span class="city-metric-value">${t.score}/10</span>
            </div>
            <div class="city-metric">
                <span class="city-metric-label">EBITDA An1:</span>
                <span class="city-metric-value">${t.ebitda>=0?"+":""}${t.ebitda}M€</span>
            </div>
            <div class="city-metric">
                <span class="city-metric-label">Equity:</span>
                <span class="city-metric-value">${t.equity}M€</span>
            </div>
            <div class="city-metric">
                <span class="city-metric-label">Statut:</span>
                <span class="city-metric-value">${t.status}</span>
            </div>
        </div>
    `).join("")}generateContexteSection(){return`
    <!-- 2. CONTEXTE -->
    ...
    <div class="page-break"></div>
    `}generateReglementationSection(){return`
    <!-- 3. RÉGLEMENTATION -->
    ...
    <div class="page-break"></div>
    `}generateProduitsSection(){return`
    <!-- 4. MIX PRODUITS -->
    ...
    <div class="page-break"></div>
    `}generateRentabiliteSection(){return`
    <!-- 6. RENTABILITÉ -->
    ...
    <div class="page-break"></div>
    `}generateFinancementSection(){return`
    <!-- 7. FINANCEMENT -->
    ...
    <div class="page-break"></div>
    `}generateImpactSocialSection(){return`
    <!-- 8. IMPACT SOCIAL -->
    ...
    <div class="page-break"></div>
    `}generateAnalyseDecisionnelleSection(){return`
    ...
    `}}export{i as HtmlReportGenerator,i as default};
