...
export const villesData: City[] = [
  ...
  { ville: 'Zoug', scorePondere: 7.73, scoreTotal: 10 },
...
export const spiderData: SpiderData[] = [
  { subject: 'Réglementation', Paris: 10, Genève: 10, Zoug: 9.5, Amsterdam: 10, Singapour: 9, Chypre: 8 },
  { subject: 'Impact Social', Paris: 8.5, Genève: 7.9, Zoug: 7.0, Amsterdam: 7.75, Singapour: 7.2, Chypre: 6.3 },
  { subject: 'ROI', Paris: 5.46, Genève: 5.92, Zoug: 7.2, Amsterdam: 5.61, Singapour: 5.8, Chypre: 4.95 },
  { subject: 'Financement', Paris: 10, Genève: 10, Zoug: 9, Amsterdam: 9, Singapour: 8.5, Chypre: 9 },
  { subject: 'Cash Management', Paris: 6.66, Genève: 6.85, Zoug: 7.5, Amsterdam: 6.93, Singapour: 6.2, Chypre: 5.5 }
];
...
// Financial metrics for top 4 cities (including Zoug)
export const metriquesTop3: Record<string, FinancialMetrics> = {
  ...
  Zoug: { ebitdaAn1: -0.8, roi3ans: 175.0, sgaTonne: 611, resultat3ans: 10.8 },
